  ...
  return (
    <div className="border-b border-neutral-900 pb-4">
      ...
      <div className=" flex justify-center flex-row">
        <div className=" gap-8 mt-8 mb-8 flex flex-row">
          <motion.div
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 1 }}
            initial={{ opacity: 0, x: -100 }}
            className=" px-6 py-6 flex-1 rounded-2xl  border-4 border-neutral-800 p-4 text-center"
          >
            <motion.h2
              whileInView={{ opacity: 1, y: 0 }}
              initial={{ opacity: 0, y: 100 }}
            ...
            <div className=" flex text-left flex-wrap gap-10 justify-around">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-purple-800">Experienced</p>
                </div>
              </motion.article>
              <motion.article
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-purple-800">Intermediate</p>
                </div>
              </motion.article>
              <motion.article
                whileInView={{ opacity: 1, y: 0 }}
